...
查询性能低下的主要原因是访问的数据量太多，某些查询不可避免的需要筛选大量的数据，我们可以进行减少访问数据量的方式进行优化，对于低效的查询，下面两个步骤分析很有效：
...
1. join的实现原理
   ...
   - Block Nested-Loop Join
     ...
     ![image-20201215214140746](https://yeyangshu-picgo.oss-cn-shanghai.aliyuncs.com/img/image-20201215214140746.png)
...
2. 案例演示
   ...
   ![image-20201215214241867](https://yeyangshu-picgo.oss-cn-shanghai.aliyuncs.com/img/image-20201215214241867.png)
