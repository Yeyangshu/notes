...
![img](https://yeyangshu-picgo.oss-cn-shanghai.aliyuncs.com/img/5)
...
https://zipkin.io/
Quickstart
latest release：https://repo1.maven.org/maven2/io/zipkin/zipkin-server/2.21.7/zipkin-server-2.21.7-exec.jar

历史版本：https://dl.bintray.com/openzipkin/maven/io/zipkin/java/zipkin-server/
```
