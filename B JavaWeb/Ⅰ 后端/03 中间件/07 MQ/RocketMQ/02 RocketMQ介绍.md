...
![image-20210119193943387](https://yeyangshu-picgo.oss-cn-shanghai.aliyuncs.com/img/image-20210119193943387.png)
...
## 3 对比JMS中的Topic和Queue

Topic是一个逻辑上的概念，实际上Message是在每个Broker上以Queue的形式记录。

![image-20210119194025516](https://yeyangshu-picgo.oss-cn-shanghai.aliyuncs.com/img/image-20210119194025516.png)
